              ...
              <div className="space-y-6 bg-white p-4 md:p-5 rounded-lg border border-slate-200 shadow-sm">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <InputField label="Mã số đăng ký hưu trí (nếu có)" value={customer.pensionSystemRegistrationNumber} onChange={(e: any) => handleChange('pensionSystemRegistrationNumber', e.target.value)} />
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <InputField label="Mã Ngân hàng (金融機関コード)" value={customer.bankInstitutionCode} onChange={(e: any) => handleChange('bankInstitutionCode', e.target.value)} />
                    ...
                    <InputField label="Mã Chi nhánh (支店コード)" value={customer.branchCode} onChange={(e: any) => handleChange('branchCode', e.target.value)} />
                    ...
                    <div className="space-y-1">
                      ...
                      <select value={customer.bankAccountType || ''} onChange={(e: any) => handleChange('bankAccountType', e.target.value)} className="w-full h-8 px-2.5 py-1 border-slate-300 rounded-md text-sm bg-white focus:ring-indigo-500 focus:border-indigo-500 transition-colors shadow-sm">
                        <option value="">-- Chọn --</option>
