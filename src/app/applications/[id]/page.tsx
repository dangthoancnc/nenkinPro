        ...
        <div className="flex items-center gap-2">
          {!isEditing ? (
            <>
              ...
              {!isNew && (
                <Button type="button" variant="secondary" size="sm" onClick={() => setShowPrintModal(true)}
                    ...
                    <div className="space-y-3">
                      ...
                      <FormField label="Địa chỉ trên thẻ (Kanji)">
                        <Input {...register('zairyuAddress')} disabled={!isEditing} size="md"
                          ...
                          rightIcon={
                            watch('zairyuAddress') ? (
                              <button type="button" onClick={() => window.open(`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(watch('zairyuAddress')||'')}`, '_blank')} className="text-indigo-500 hover:text-indigo-700 transition-colors">
                      ...
                      <FormField label="Mã Bưu Điện">
                        <Input {...register('postalCode')} disabled={!isEditing} size="md" placeholder="VD: 4530015"
                          ...
                          rightIcon={
                            <button type="button" onClick={() => handleNtaSearch(watch('postalCode'))} className="text-indigo-500 hover:text-indigo-700 transition-colors">
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-3 min-h-0">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-1.5">
                  ...
                  <FormField label="Ngày nhận Lần 1">
                    <Input type="date" {...register('received1stDate')} disabled={!isEditing} size="sm" />
                  </FormField>
                  <FormField label="Ngày nộp Lần 2">
                    <Input type="date" {...register('sent2ndDate')} disabled={!isEditing} size="sm" />
                  </FormField>
                  <FormField label="Ngày nhận Lần 2">
