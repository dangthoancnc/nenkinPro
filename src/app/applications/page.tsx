                  ...
                  <div className="p-4 flex-1 flex flex-col">
                    ...
                    <div className="flex items-center gap-2">
                      <Link 
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-semibold transition-colors bg-slate-50 border border-slate-200 rounded-lg group-hover:bg-primary group-hover:text-white group-hover:border-primary text-slate-600"
                      >
                        Chi tiết hồ sơ
                        <ArrowRight className="w-3.5 h-3.5" />
                      </Link>
                      <a
                        href={`/customer/portal?id=${(app.customer as any)?.id || ''}`}
                        target="_blank"
                        rel="noreferrer"
                        className="px-2.5 py-2 inline-flex items-center justify-center text-xs font-bold text-indigo-700 bg-indigo-50 border border-indigo-200 hover:bg-indigo-100 rounded-lg transition-colors shadow-2xs shrink-0"
                        title="Mở tab mới xem giao diện Tra cứu của Khách hàng"
                      >
