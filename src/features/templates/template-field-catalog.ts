...
export const TEMPLATE_FIELD_CATALOG: FieldGroup[] = [
  ...
  },
  {
    ...
    tags: [
      ...
      { id: 'taxRep_name', label: 'Người đại diện thuế: Tên (taxRep_name)', appliesTo: ['giay_uy_thac_lan_2', 'nouzeikanrinin', 'bang_1_2', 'bang_3'] },
      ...
      { id: 'taxRep_furigana', label: 'Người đại diện thuế: Tên Furigana (taxRep_furigana)', appliesTo: ['giay_uy_thac_lan_2', 'nouzeikanrinin', 'bang_1_2', 'bang_3'] },
