...
export const TEMPLATE_FIELD_CATALOG: FieldGroup[] = [
  ...
  },
  {
    ...
    tags: [
      ...
      { id: 'overseasCountry', label: 'Quốc gia hải ngoại', appliesTo: ['don_xin_lan_1', 'nouzeikanrinin'] },
      { id: 'overseasStreet', label: 'Số nhà, đường hải ngoại', appliesTo: ['don_xin_lan_1', 'nouzeikanrinin'] },
      { id: 'overseasCity', label: 'Thành phố hải ngoại', appliesTo: ['don_xin_lan_1', 'nouzeikanrinin'] },
      { id: 'overseasProvince', label: 'Tỉnh/Bang hải ngoại', appliesTo: ['don_xin_lan_1', 'nouzeikanrinin'] },
      { id: 'overseasPostalCode', label: 'Mã bưu điện hải ngoại', appliesTo: ['don_xin_lan_1', 'nouzeikanrinin'] },
      { id: 'overseasAddress', label: 'Địa chỉ hải ngoại (Nguyên khối VN)', appliesTo: ['nouzeikanrinin'] },
