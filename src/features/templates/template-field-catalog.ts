...
export const TEMPLATE_FIELD_CATALOG: FieldGroup[] = [
  {
    ...
    tags: [
      ...
      { id: 'phone_1', label: 'Khách hàng: SĐT Khối 1 (VD: 0912 / 090)', appliesTo: ALL_TEMPLATES },
      { id: 'phone_2', label: 'Khách hàng: SĐT Khối 2 (VD: 3456 / 1234)', appliesTo: ALL_TEMPLATES },
      { id: 'phone_3', label: 'Khách hàng: SĐT Khối 3 (VD: 7890 / 5678)', appliesTo: ALL_TEMPLATES },
