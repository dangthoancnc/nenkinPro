...
export const TEMPLATE_FIELD_CATALOG: FieldGroup[] = [
  {
    ...
    tags: [
      ...
      { id: 'phone_part1', label: 'Khách hàng: SĐT Khối 1 (VD: 090)', appliesTo: ALL_TEMPLATES },
      { id: 'phone_part2', label: 'Khách hàng: SĐT Khối 2 (VD: 1234)', appliesTo: ALL_TEMPLATES },
      { id: 'phone_part3', label: 'Khách hàng: SĐT Khối 3 (VD: 5678)', appliesTo: ALL_TEMPLATES },
  ...
  },
  {
    ...
    tags: [
      ...
      { id: 'overseasProvince', label: 'Tỉnh/Bang hải ngoại', appliesTo: ALL_TEMPLATES },
      { id: 'overseasPostalCode', label: 'Mã bưu điện VN / Hải ngoại (Nguyên khối - VD: 100000)', appliesTo: ALL_TEMPLATES },
      { id: 'overseasAddress', label: 'Địa chỉ tại Việt Nam / Hải ngoại (Nguyên khối)', appliesTo: ALL_TEMPLATES },
  ...
  {
    name: '2c. Thông tin liên hệ & Địa chỉ tại Việt Nam (Hải ngoại)',
    tags: [
      { id: 'overseasAddress', label: 'Địa chỉ tại Việt Nam (Nguyên khối VN)', appliesTo: ALL_TEMPLATES },
      { id: 'vietnamAddress', label: 'Địa chỉ tại Việt Nam (vietnamAddress)', appliesTo: ALL_TEMPLATES },
      { id: 'overseasPostalCode', label: 'Mã Bưu điện VN (Nguyên khối - VD: 100000)', appliesTo: ALL_TEMPLATES },
      { id: 'vietnamPostalCode', label: 'Mã Bưu điện VN (vietnamPostalCode)', appliesTo: ALL_TEMPLATES },
      ...generateSplitTags('overseasPostalCode', 6, 'Mã BĐ VN (overseasPostalCode)'),
      ...generateSplitTags('vietnamPostalCode', 6, 'Mã BĐ VN (vietnamPostalCode)'),
      { id: 'overseasCountry', label: 'Quốc gia (VIET NAM)', appliesTo: ALL_TEMPLATES },
      { id: 'overseasProvince', label: 'Tỉnh / Thành phố tại Việt Nam', appliesTo: ALL_TEMPLATES },
      { id: 'overseasCity', label: 'Quận / Huyện tại Việt Nam', appliesTo: ALL_TEMPLATES },
      { id: 'overseasStreet', label: 'Số nhà, đường phố tại Việt Nam', appliesTo: ALL_TEMPLATES },
      { id: 'vietnamPhone', label: 'Số điện thoại tại VN (VD: 0987654321)', appliesTo: ALL_TEMPLATES },
      { id: 'phone_vn', label: 'Số điện thoại tại VN (phone_vn)', appliesTo: ALL_TEMPLATES },
      { id: 'email', label: 'Địa chỉ Email liên hệ', appliesTo: ALL_TEMPLATES },
      { id: 'facebookUrl', label: 'Link Facebook liên hệ', appliesTo: ALL_TEMPLATES },
      { id: 'zaloPhone', label: 'Số điện thoại Zalo', appliesTo: ALL_TEMPLATES },
    ]
  },
  {
    name: '2b. Nội dung Ủy Quyền Lần 1 & Đại lý nhận ủy quyền',
    tags: [
      { id: 'delegation_nenkin_period_mark', label: 'Ủy thác Mục 1: Khoanh chọn 年金の加入期間 (○)', format: 'mark', appliesTo: ['ininjyo_yoshiki_lan_1'] },
      { id: 'delegation_nenkin_estimate_mark', label: 'Ủy thác Mục 2: Khoanh chọn 年金の見込額 (○)', format: 'mark', appliesTo: ['ininjyo_yoshiki_lan_1'] },
      { id: 'delegation_nenkin_claim_mark', label: 'Ủy thác Mục 3: Khoanh chọn 年金の請求 (○)', format: 'mark', appliesTo: ['ininjyo_yoshiki_lan_1'] },
      { id: 'delegation_nenkin_reissue_mark', label: 'Ủy thác Mục 4: Khoanh chọn 年金手帳等の再交付 (○)', format: 'mark', appliesTo: ['ininjyo_yoshiki_lan_1'] },
      { id: 'delegation_other_mark', label: 'Ủy thác Mục 5: Khoanh chọn その他 (○)', format: 'mark', appliesTo: ['ininjyo_yoshiki_lan_1'] },
  ...
  },
  {
    ...
    tags: [
      ...
      { id: 'dob_era_meiji_mark', label: 'Ngày sinh: Khoanh chọn 明治 (○)', format: 'mark', appliesTo: ALL_TEMPLATES },
      { id: 'dob_era_taisho_mark', label: 'Ngày sinh: Khoanh chọn 大正 (○)', format: 'mark', appliesTo: ALL_TEMPLATES },
      { id: 'dob_era_showa_mark', label: 'Ngày sinh: Khoanh chọn 昭和 (○)', format: 'mark', appliesTo: ALL_TEMPLATES },
      { id: 'dob_era_heisei_mark', label: 'Ngày sinh: Khoanh chọn 平成 (○)', format: 'mark', appliesTo: ALL_TEMPLATES },
      { id: 'dob_era_reiwa_mark', label: 'Ngày sinh: Khoanh chọn 令和 (○)', format: 'mark', appliesTo: ALL_TEMPLATES },
      ...
      { id: 'departureDate_y', label: 'Ngày xuất cảnh: Năm YYYY (VD: 2024)', appliesTo: ['nouzeikanrinin', 'don_xin_lan_1'] },
      { id: 'departureDate_m', label: 'Ngày xuất cảnh: Tháng MM (VD: 12)', appliesTo: ['nouzeikanrinin', 'don_xin_lan_1'] },
      { id: 'departureDate_d', label: 'Ngày xuất cảnh: Ngày DD (VD: 20)', appliesTo: ['nouzeikanrinin', 'don_xin_lan_1'] },
      { id: 'departure_y', label: 'Ngày xuất cảnh: Năm YYYY (departure_y)', appliesTo: ['nouzeikanrinin'] },
      { id: 'departure_m', label: 'Ngày xuất cảnh: Tháng MM (departure_m)', appliesTo: ['nouzeikanrinin'] },
      { id: 'departure_d', label: 'Ngày xuất cảnh: Ngày DD (departure_d)', appliesTo: ['nouzeikanrinin'] },
      ...generateSplitTags('departureDate_y', 4, 'Ngày xuất cảnh: Năm', ['nouzeikanrinin', 'don_xin_lan_1']),
      ...generateSplitTags('departureDate_m', 2, 'Ngày xuất cảnh: Tháng', ['nouzeikanrinin', 'don_xin_lan_1']),
      ...generateSplitTags('departureDate_d', 2, 'Ngày xuất cảnh: Ngày', ['nouzeikanrinin', 'don_xin_lan_1']),
  ...
  },
  {
    ...
    tags: [
      { id: 'taxOfficeName', label: 'Tên Cục Thuế (VD: 半田税務署)', appliesTo: ['nouzeikanrinin', 'bang_1_2', 'bang_3'] },
      { id: 'taxOffice_shortName', label: 'Tên Cục Thuế viết tắt (VD: 半田)', appliesTo: ['nouzeikanrinin', 'bang_1_2', 'bang_3'] },
      ...
      { id: 'taxRep_fullName', label: 'Người đại diện thuế: Tên Romaji / Kanji (VD: DAO THI DUYEN)', appliesTo: ['ininjyo_yoshiki_lan_1', 'nouzeikanrinin', 'bang_1_2', 'bang_3'] },
      { id: 'taxRep_fullNameKana', label: 'Người đại diện thuế: Tên Furigana Katakana (VD: ダオ ティ デュエン)', appliesTo: ['ininjyo_yoshiki_lan_1', 'nouzeikanrinin', 'bang_1_2', 'bang_3'] },
      { id: 'taxRep_address', label: 'Người đại diện thuế: Địa chỉ tại Nhật', appliesTo: ['ininjyo_yoshiki_lan_1', 'nouzeikanrinin', 'bang_1_2', 'bang_3'] },
      { id: 'taxRep_postalCodeFormat', label: 'Người đại diện thuế: Mã BĐ (Nguyên khối - VD: 212-0055)', appliesTo: ['ininjyo_yoshiki_lan_1', 'nouzeikanrinin'] },
      { id: 'taxRep_postalCode_part1', label: 'Người đại diện thuế: Mã BĐ Khối 1 (3 số đầu - VD: 212)', appliesTo: ['ininjyo_yoshiki_lan_1', 'nouzeikanrinin'] },
      { id: 'taxRep_postalCode_part2', label: 'Người đại diện thuế: Mã BĐ Khối 2 (4 số sau - VD: 0055)', appliesTo: ['ininjyo_yoshiki_lan_1', 'nouzeikanrinin'] },
      ...generateSplitTags('taxRep_post', 7, 'Người đại diện thuế: Mã BĐ (Ô taxRep_post)', ['ininjyo_yoshiki_lan_1', 'nouzeikanrinin']),
      { id: 'taxRep_phone', label: 'Người đại diện thuế: SĐT (Viết liền - VD: 080-9876-5432)', appliesTo: ['ininjyo_yoshiki_lan_1', 'nouzeikanrinin'] },
      { id: 'taxRep_phone_part1', label: 'Người đại diện thuế: SĐT Khối 1 (3 số đầu - VD: 090)', appliesTo: ['ininjyo_yoshiki_lan_1', 'nouzeikanrinin'] },
      { id: 'taxRep_phone_part2', label: 'Người đại diện thuế: SĐT Khối 2 (4 số giữa - VD: 4366)', appliesTo: ['ininjyo_yoshiki_lan_1', 'nouzeikanrinin'] },
      { id: 'taxRep_phone_part3', label: 'Người đại diện thuế: SĐT Khối 3 (4 số cuối - VD: 3870)', appliesTo: ['ininjyo_yoshiki_lan_1', 'nouzeikanrinin'] },
      { id: 'taxRep_relationship', label: 'Người đại diện thuế: Quan hệ với Khách hàng (VD: 納税管理人)', appliesTo: ['ininjyo_yoshiki_lan_1', 'nouzeikanrinin'] },
      { id: 'taxRep_occupation', label: 'Người đại diện thuế: Nghề nghiệp', appliesTo: ['nouzeikanrinin'] },
      { id: 'taxRep_dob_y', label: 'Người đại diện thuế: Năm sinh Tây (Nguyên khối YYYY - VD: 1991)', appliesTo: ['nouzeikanrinin'] },
      { id: 'taxRep_dob_m', label: 'Người đại diện thuế: Tháng sinh (Nguyên khối MM - VD: 04)', appliesTo: ['nouzeikanrinin'] },
      { id: 'taxRep_dob_d', label: 'Người đại diện thuế: Ngày sinh (Nguyên khối DD - VD: 02)', appliesTo: ['nouzeikanrinin'] },
      { id: 'taxRep_appoint_mark', label: 'Mục 1: Chọn 選任 (○)', format: 'mark', appliesTo: ['nouzeikanrinin'], required: true },
      { id: 'taxRep_dismiss_mark', label: 'Mục 1: Hủy 解任 (○)', format: 'mark', appliesTo: ['nouzeikanrinin'] },
      { id: 'taxRep_appoint_reason', label: 'Mục 4: Lý do chỉ định (出国のため)', appliesTo: ['nouzeikanrinin'] },
      { id: 'income_salary_mark', label: 'Mục 5-(2): Thu nhập 给与所得 (○)', format: 'mark', appliesTo: ['nouzeikanrinin'] },
      { id: 'income_business_mark', label: 'Mục 5-(2): Thu nhập 事業所得 (○)', format: 'mark', appliesTo: ['nouzeikanrinin'] },
      { id: 'income_realestate_mark', label: 'Mục 5-(2): Thu nhập 不動産所得 (○)', format: 'mark', appliesTo: ['nouzeikanrinin'] },
      { id: 'income_transfer_mark', label: 'Mục 5-(2): Thu nhập 譲渡所得 (○)', format: 'mark', appliesTo: ['nouzeikanrinin'] },
      { id: 'income_other_detail', label: 'Mục 5-(2): Thu nhập khác (退職所得（脱退一時金）)', appliesTo: ['nouzeikanrinin'] },
      { id: 'other_reference_note', label: 'Mục 5-(3): Ghi chú tham khảo khác (その他)', appliesTo: ['nouzeikanrinin'] },
    ]
  },
  {
