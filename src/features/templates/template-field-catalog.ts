...
export const TEMPLATE_FIELD_CATALOG: FieldGroup[] = [
  {
    ...
    tags: [
      ...
      { id: 'phone_part1', label: 'Khách hàng: SĐT Khối 1 (phone_part1)', appliesTo: ALL_TEMPLATES },
      { id: 'phone_part2', label: 'Khách hàng: SĐT Khối 2 (phone_part2)', appliesTo: ALL_TEMPLATES },
      { id: 'phone_part3', label: 'Khách hàng: SĐT Khối 3 (phone_part3)', appliesTo: ALL_TEMPLATES },
  ...
  },
  {
    ...
    tags: [
      ...
      { id: 'post_part1', label: 'Mã BĐ Nhật: Khối 1 (post_part1)', appliesTo: ALL_TEMPLATES },
      { id: 'post_part2', label: 'Mã BĐ Nhật: Khối 2 (post_part2)', appliesTo: ALL_TEMPLATES },
  ...
  },
  {
    ...
    tags: [
      ...
      { id: 'taxRep_fullName', label: 'Người đại diện thuế: Tên Romaji / Kanji (VD: DAO THI B)', appliesTo: ['giay_uy_thac_lan_2', 'nouzeikanrinin', 'bang_1_2', 'bang_3'] },
      { id: 'taxRep_fullNameKana', label: 'Người đại diện thuế: Tên Furigana Katakana', appliesTo: ['giay_uy_thac_lan_2', 'nouzeikanrinin', 'bang_1_2', 'bang_3'] },
      ...
      { id: 'taxRep_post_part1', label: 'Người đại diện thuế: Mã BĐ Khối 1 (taxRep_post_part1)', appliesTo: ['giay_uy_thac_lan_2', 'nouzeikanrinin'] },
      { id: 'taxRep_post_part2', label: 'Người đại diện thuế: Mã BĐ Khối 2 (taxRep_post_part2)', appliesTo: ['giay_uy_thac_lan_2', 'nouzeikanrinin'] },
      { id: 'rep_post_part1', label: 'Người đại diện thuế: Mã BĐ Khối 1 (rep_post_part1)', appliesTo: ['giay_uy_thac_lan_2', 'nouzeikanrinin'] },
      { id: 'rep_post_part2', label: 'Người đại diện thuế: Mã BĐ Khối 2 (rep_post_part2)', appliesTo: ['giay_uy_thac_lan_2', 'nouzeikanrinin'] },
