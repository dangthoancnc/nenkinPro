export const MOCK_DATA: Record<string, string> = {
  ...
  tax_residence_mark: '○',
  address_tax_mark: '○',
  overseasAddress: 'XOM MY THINH, XA HUNG NGUYEN, NGHE AN, VIET NAM',
  overseasCountry: 'VIET NAM',
  overseasStreet: 'XOM MY THINH, XA HUNG NGUYEN, NGHE AN, VIET NAM',
  overseasCity: 'HUNG NGUYEN',
  overseasProvince: 'NGHE AN',
  ...
  // 6. Nộp thuế & Người đại diện thuế (Cá nhân)
  taxOfficeName: '半田税務署',
  taxOffice_shortName: '半田',
  taxOfficeAddress: '愛知県半田市宮路町1-1',
  taxRep_fullName: 'DAO THI B',
  taxRep_fullNameKana: 'ダオ ティ B',
